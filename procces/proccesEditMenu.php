<?php
    ...
    $menu_cat = (isset($_POST['menu_cat'])) ? htmlentities($_POST['menu_cat']) : "";
        ...
        if($statusUpload == 0){
            ...
            window.location="../menu" </script>';
                ...
                if(move_uploaded_file($_FILES['foto']['tmp_name'],$target_file)){
                    $query = mysqli_query($conn, "UPDATE tbmenulist SET photo='". $code_rand . $_FILES['foto']['tmp_name'] . "' menu_name='$menu_name', information='$information', menu_cat='$menu_cat', category='$category', price='$price', stock='$stock' WHERE id='$id'");
                    if ($query) {
